...
public sealed class MissionImageConfiguration : IEntityTypeConfiguration<MissionImage>
{
    ...
    {
        builder.ConfigureBase("mission_images"); builder.Property(x => x.MinioObjectKey).HasMaxLength(1024).IsRequired(); builder.Property(x => x.ThumbnailObjectKey).HasMaxLength(1024); builder.Property(x => x.MimeType).HasMaxLength(255).IsRequired();
